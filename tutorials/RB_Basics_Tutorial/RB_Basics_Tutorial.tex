...
\begin{lstlisting}    
    ...
    RevBayes > dexp(x=1,rate=1)         # exponential distribution density function
    ...
    RevBayes > ddnNorm(-2.0,0.0,1.0)              # normal distribution density function
    RevBayes > rdnNorm(n=10,0,1)                  # random draws from a normal distribution
\end{lstlisting}
\end{snugshade*}}
