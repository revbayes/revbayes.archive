...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=6in]{figures/acln_gm.eps}}
...
Additionally, you may find that the power-posterior analysis runs far too slow under this model, thus it may be advisable for you to decrease the number of steps (\cl{cats}) or the length of the burn-in period or run.
