...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=3in]{figures/bears_dosReis.eps}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=4in]{figures/yule_gm2.eps}}
...
We can now visualize our graphical model using the \cl{.gv()} member method of the model object. 
...
First create the model graph file using the \cl{.gv()} method. Set the flag for extra output (good for development debugging) to false: \cl{verbose=false}.
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=3in]{figures/m_Yule_bears_GM.eps}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=3in]{figures/simple_BD_gm_root.eps}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=3in]{figures/cBDR_gm.eps}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=3in]{figures/m_BD_bears_GM.eps}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=4in]{figures/div_tracer.pdf}}
