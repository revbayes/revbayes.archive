...
Apart from the first exercise which requires copying and pasting from this document, scripts are all placed in \emph{$tutorials/RB_GeneTreeSpeciesTree_Tutorial/RB_tutorial_files/RevBayes_scripts/$}, in four folders. 
...
{\begin{framed}
\begin{center}
\emph{WARNING: The following script may be less up to date than the simulation scripts named "MultiSpeciesCoalescentSimulatingTreesAndAlignments.Rev".}
\end{center}
\end{framed}}
\vspace{5mm}
