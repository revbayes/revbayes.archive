...
Apart from the first exercise which requires copying and pasting from this document, scripts are all placed in \emph{$tutorials/RB\_GeneTreeSpeciesTree\_Tutorial/RB\_tutorial\_files/RevBayes\_scripts/$}, in four folders. 
