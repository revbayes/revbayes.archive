#ifndef Move_ScaleKernelMixture_H
#define Move_ScaleKernelMixture_H
...
namespace RevLanguage {
     ...
     *
     */
    class Move_ScaleKernelMixture : public Move {

    public:

        Move_ScaleKernelMixture(void);                                                                                                                       //!< Default constructor

        // Basic utility functions
        virtual Move_ScaleKernelMixture*                         clone(void) const;                                                                          //!< Clone object
