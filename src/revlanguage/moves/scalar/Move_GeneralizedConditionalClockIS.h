#ifndef Move_GeneralizedConditionalClockIS_H
#define Move_GeneralizedConditionalClockIS_H
...
namespace RevLanguage {
     ...
     *
     * This class is the RevLanguage wrapper of GeneralizedConditionalClockIS.
     *
     * @author The RevBayes Development Core Team (Sebastian Hoehna)
     * @copyright GPL version 3
     * @since 2016-08-31, version 1.0
     */
    class Move_GeneralizedConditionalClockIS : public Move {
        
    public:
        
        Move_GeneralizedConditionalClockIS(void);                                                                                                                    //!< Default constructor
        
        // Basic utility functions
        virtual Move_GeneralizedConditionalClockIS*            clone(void) const;                                                                              //!< Clone the object
    ...
    protected:
        ...
        RevPtr<const RevVariable>                   substitutionTreeLength;                                                                                              //!< The variable holding the real valued vector.
