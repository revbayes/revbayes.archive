#ifndef Move_PathCharacterHistoryRejectionSample_H
#define Move_PathCharacterHistoryRejectionSample_H
...
namespace RevLanguage {
     ...
     *
     */
    class Move_PathCharacterHistoryRejectionSample : public Move {
        
    public:
        
        Move_PathCharacterHistoryRejectionSample(void);                                                                                                                        //!< Default constructor
        
        // Basic utility functions
        virtual Move_PathCharacterHistoryRejectionSample*                          clone(void) const;                                                                          //!< Clone object
