...
const MemberRules& Move_MatrixRealSymmetricSlide::getParameterRules(void) const
{
    ...
    if ( !rulesSet )
    {
        ...
        moveMemberRules.push_back( new ArgumentRule( "x"     , MatrixRealSymmetric::getClassTypeSpec(), "The matrix variable on which this move operates.", ArgumentRule::BY_REFERENCE, ArgumentRule::STOCHASTIC, NULL ) );
