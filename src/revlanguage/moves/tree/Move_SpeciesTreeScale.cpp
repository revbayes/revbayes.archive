...
void Move_SpeciesTreeScale::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
   ...
   */
  std::string Move_SpeciesTreeScale::getHelpDescription(void) const
  {
      // create a variable for the description of the function
      std::string description =  "Makes a tree scale move both in the species tree and in the gene trees. Tree topologies are not altered." ;
   ...
   */
  std::string Move_SpeciesTreeScale::getHelpDetails(void) const
  {
      // create a variable for the description of the function
      std::string details = "";
      ...
      details += "This move jointly performs a tree scale move (the entire tree is scaled up or down, keeping the topology fixed) on the species tree and on gene trees, all of which must be ultrametric.";
