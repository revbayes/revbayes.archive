 ...
 */
std::vector<std::string> Dist_pointMassPositive::getHelpAuthor(void) const
{
 ...
 */
std::string Dist_pointMassPositive::getHelpDescription(void) const
{
 ...
 */
std::string Dist_pointMassPositive::getHelpDetails(void) const
{
    // create a variable for the description of the function
    std::string details = "";
 ...
 */
std::string Dist_pointMassPositive::getHelpExample(void) const
{
 ...
 *
 */
std::vector<RevBayesCore::RbHelpReference> Dist_pointMassPositive::getHelpReferences(void) const
{
 ...
 */
std::vector<std::string> Dist_pointMassPositive::getHelpSeeAlso(void) const
{
 ...
 */
std::string Dist_pointMassPositive::getHelpTitle(void) const
{
