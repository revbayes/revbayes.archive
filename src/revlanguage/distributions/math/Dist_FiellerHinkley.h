#ifndef Dist_FiellerHinkley_H
#define Dist_FiellerHinkley_H
...
namespace RevLanguage {
     ...
     * @author Andrew Magee
     * @since 2017-11-10, version 1.0
     *
     */
    class Dist_FiellerHinkley : public ContinuousDistribution {
    
    public:
        Dist_FiellerHinkley( void );
    
        // Basic utility functions
        Dist_FiellerHinkley*                                clone(void) const;                                                                      //!< Clone the object
        ...
        RevBayesCore::FiellerHinkleyDistribution*               createDistribution(void) const;
    ...
    private:
        ...
        RevPtr<const RevVariable>                          mu1;
        RevPtr<const RevVariable>                          sd1;
        RevPtr<const RevVariable>                          mu2;
