#ifndef Dist_normalTruncatedal_H
#define Dist_normalTruncatedal_H
...
namespace RevLanguage {
     ...
     *
     */
    class Dist_normalTruncated :  public ContinuousDistribution {
        
    public:
        Dist_normalTruncated( void );
        
        // Basic utility functions
        Dist_normalTruncated*                           clone(void) const;                                                                      //!< Clone the object
