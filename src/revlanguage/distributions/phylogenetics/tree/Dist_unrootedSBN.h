...
namespace RevLanguage {
    ...
    private:
        ...
        RevPtr<const RevVariable>                       rootSplits;
        RevPtr<const RevVariable>                       rootSplitProbabilities;
        RevPtr<const RevVariable>                       subsplitChildren; // This is a vector of vectors of vectors, where subsplit_children[i] is all children of subsplit[i], subsplit_children[i][0] is all subsplits of clade X of i, and subsplit_children[i][1][j] is a specific child of subsplit i's clade Y.
        RevPtr<const RevVariable>                       subsplitProbabilities; // For every parent-child subsplit pair recorded in subsplit_children, this is the probability of that transition
    };
