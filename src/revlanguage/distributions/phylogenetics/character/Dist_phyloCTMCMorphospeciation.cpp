#include "Dist_phyloCTMCMorphospeciation.h"
...
Dist_phyloCTMCMorphospeciation::Dist_phyloCTMCMorphospeciation() : TypedDistribution< AbstractHomologousDiscreteCharacterData >()
{

}


Dist_phyloCTMCMorphospeciation::~Dist_phyloCTMCMorphospeciation()
{
...
Dist_phyloCTMCMorphospeciation* Dist_phyloCTMCMorphospeciation::clone( void ) const
{

    return new Dist_phyloCTMCMorphospeciation(*this);
}


RevBayesCore::TypedDistribution< RevBayesCore::AbstractHomologousDiscreteCharacterData >* Dist_phyloCTMCMorphospeciation::createDistribution( void ) const
{
...
const std::string& Dist_phyloCTMCMorphospeciation::getClassType(void)
{

    static std::string rev_type = "Dist_phyloCTMCMorphospeciation";

    return rev_type;
}

/* Get class type spec describing type of object */
const TypeSpec& Dist_phyloCTMCMorphospeciation::getClassTypeSpec(void)
{
 ...
 */
std::string Dist_phyloCTMCMorphospeciation::getDistributionFunctionName( void ) const
{
...
MethodTable Dist_phyloCTMCMorphospeciation::getDistributionMethods( void ) const
{
    ...
    methods.addFunction( new DistributionMemberFunction<Dist_phyloCTMCMorphospeciation, ModelVector<Real> >( "siteLikelihoods", variable, siteLikelihoodsArgRules, true ) );
    ...
    methods.addFunction( new DistributionMemberFunction<Dist_phyloCTMCMorphospeciation, MatrixReal >( "siteRateLikelihoods", variable, siteRateLikelihoodsArgRules, true ) );
    ...
    methods.addFunction( new DistributionMemberFunction<Dist_phyloCTMCMorphospeciation, MatrixReal >( "siteMixtureLikelihoods", variable, siteMixtureLikelihoodsArgRules, true ) );
    ...
    methods.addFunction( new DistributionMemberFunction<Dist_phyloCTMCMorphospeciation, ModelVector<RealPos> >( "siteRates", variable, siteRatesArgRules, true ) );
...
const MemberRules& Dist_phyloCTMCMorphospeciation::getParameterRules(void) const
{
...
const TypeSpec& Dist_phyloCTMCMorphospeciation::getTypeSpec( void ) const
{
...
void Dist_phyloCTMCMorphospeciation::printValue(std::ostream& o) const
{
...
void Dist_phyloCTMCMorphospeciation::setConstParameter(const std::string& name, const RevPtr<const RevVariable> &var)
{
