 ...
 */
RbPtr<Variable> SyntaxDecrement::evaluateContent( Environment& env ) 
{
 ...
 */
void SyntaxDecrement::replaceVariableWithConstant(const std::string& name, const RbLanguageObject& c) {
