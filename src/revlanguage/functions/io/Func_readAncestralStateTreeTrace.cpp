...
/** Execute function */
RevPtr<Variable> Func_readAncestralStateTreeTrace::execute( void ) {
...
void Func_readAncestralStateTreeTrace::formatError(RevBayesCore::RbFileManager& fm, std::string& errorStr)
{
