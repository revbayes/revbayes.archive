#ifndef Func_experimentalCodonModelRateMatrix_H
#define Func_experimentalCodonModelRateMatrix_H
...
namespace RevLanguage {
     ...
     *
     */
    class Func_experimentalCodonModelRateMatrix : public TypedFunction<RateMatrix> {

    public:
        Func_experimentalCodonModelRateMatrix( void );

        // Basic utility functions
        Func_experimentalCodonModelRateMatrix*                     clone(void) const;                                          //!< Clone the object
