 ...
 *
 * @brief Declaration and implementation of Func_atlasSf
 *
...
#ifndef Func_atlasSf_H
#define Func_atlasSf_H
...
namespace RevLanguage {
    ...
    class Func_atlasSf : public Procedure {
        
    public:
        Func_atlasSf( void );
        
        // Basic utility functions
        Func_atlasSf*                                                       clone(void) const;                                                              //!< Clone the object
