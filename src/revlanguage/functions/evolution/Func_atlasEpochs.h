 ...
 *
 * @brief Declaration and implementation of Func_atlasEpochs
 *
...
#ifndef Func_atlasEpochs_H
#define Func_atlasEpochs_H
...
namespace RevLanguage {
    ...
    class Func_atlasEpochs : public Procedure {
        
    public:
        Func_atlasEpochs( void );
        
        // Basic utility functions
        Func_atlasEpochs*                                                       clone(void) const;                                                              //!< Clone the object
