...
//#include "Ellipsis.h"
//#include "GeneralUniveriateUserFunction.h"
...
//
///** Constructor */
//GeneralUnivariateUserFunction::GeneralUnivariateUserFunction( const ArgumentRules*  argRules,
//                           const TypeSpec&             retType,
//                           std::list<SyntaxElement*>*  stmts,
//                           Environment*                defineEnv)
//: UnivariateFunction(), argumentRules(argRules), returnType(retType), code(stmts), defineEnvironment(defineEnv) {
//    
//}
//
//
///** Copy constructor */
//GeneralUnivariateUserFunction::GeneralUnivariateUserFunction(const GeneralUnivariateUserFunction &x) : UnivariateFunction(x), argumentRules( new ArgumentRules(*x.argumentRules) ), returnType( x.returnType ), code( NULL ), defineEnvironment( NULL ) {
//    
...
//
//
//GeneralUnivariateUserFunction& GeneralUnivariateUserFunction::operator=(const GeneralUnivariateUserFunction &f) {
//    
//    if ( this != &f ) {
//        // call the base class assignment operator
//        UnivariateFunction::operator=(f);
//        
...
//
///** Destructor */
//GeneralUnivariateUserFunction::~GeneralUnivariateUserFunction() {
//    
...
//
///** Clone the object */
//GeneralUnivariateUserFunction* GeneralUnivariateUserFunction::clone(void) const {
//    
//    return new GeneralUnivariateUserFunction(*this);
//}
//
//
///** Execute function: call the object's internal implementation through executeOperation */
//RevBayesCore::UnivariateFunction* GeneralUnivariateUserFunction::createFunction( void ) const {
//    
//    // Clear signals
...
////    RevBayesCore::DeterministicNode<RevBayesCore::RateMatrix_GTR> *detNode = new RevBayesCore::DeterministicNode<RevBayesCore::RateMatrix_GTR>("", f);
////    
////    RateMatrix_GTR* value = new RateMatrix_GTR( detNode );
////    
////    return value;
//    
////    double *v, const TypedDagNode<double> *x, TypedDagNode<double> *result, const std::set<DagNode*> &n
////    RevBayesCore::GeneralUnivariateFunction *fx = new RevBayesCore::GeneralUnivariateFunction();
//    
//
//    
...
//const std::string& GeneralUnivariateUserFunction::getClassName(void) { 
//    
//    static std::string rbClassName = "User Univariate-function";
//    
//	return rbClassName; 
//}
//
///** Get class type spec describing type of object */
//const TypeSpec& GeneralUnivariateUserFunction::getClassTypeSpec(void) { 
//    
...
//
///** Get type spec */
//const TypeSpec& GeneralUnivariateUserFunction::getTypeSpec( void ) const {
//    
...
//
///** Get argument rules */
//const ArgumentRules& GeneralUnivariateUserFunction::getArgumentRules(void) const {
//    
...
//
///** Get return type */
//const TypeSpec& GeneralUnivariateUserFunction::getReturnType(void) const {
//    
//    return returnType;
//}
//
