...
template <typename leftValType, typename rightValType>
RevLanguage::RbLanguageObject* RevLanguage::Func__ge<leftValType,rightValType>::execute( void ) {
...
template <typename leftValType, typename rightValType>
const std::string& RevLanguage::Func__ge<leftValType,rightValType>::getClassName(void) { 
    
    static std::string rbClassName = "Func__ge<" + leftValType::getClassTypeSpec() + "," + rightValType::getClassTypeSpec() + ">";
...
const RevLanguage::TypeSpec& RevLanguage::Func__ge<leftValType,rightValType>::getClassTypeSpec(void) { 
    ...
    static TypeSpec rbClass = TypeSpec( "Func__ge", new TypeSpec( Function::getClassTypeSpec() ) );
