 ...
 * of the templated Func_sub, which is used to sub two
 * variables.
 *
 * @brief Declaration and implementation of Func_sub
 *
 ...
 * @version 1.0
 *
 * $Id: Func_sub.h 1406 2012-04-20 02:06:14Z hoehna $
 */
...
namespace RevLanguage {
    ...
    class Func_sub :  public Function {
        
    public:
        Func_sub( void );
        
        // Basic utility functions
        Func_sub*                                       clone(void) const;                                                              //!< Clone the object
...
/** default constructor */
template <typename firstValType, typename secondValType, typename retType>
RevLanguage::Func_sub<firstValType, secondValType, retType>::Func_sub( void ) : Function( ) {
...
/** Clone object */
template <typename firstValType, typename secondValType, typename retType>
RevLanguage::Func_sub<firstValType, secondValType, retType>* RevLanguage::Func_sub<firstValType, secondValType, retType>::clone( void ) const {
    
    return new Func_sub( *this );
}


template <typename firstValType, typename secondValType, typename retType>
RevLanguage::RbLanguageObject* RevLanguage::Func_sub<firstValType, secondValType, retType>::execute() {
...
/* Get argument rules */
template <typename firstValType, typename secondValType, typename retType>
const RevLanguage::ArgumentRules& RevLanguage::Func_sub<firstValType, secondValType, retType>::getArgumentRules( void ) const {
...
template <typename firstValType, typename secondValType, typename retType>
const RevLanguage::TypeSpec& RevLanguage::Func_sub<firstValType, secondValType, retType>::getClassTypeSpec(void) { 
...
/* Get return type */
template <typename firstValType, typename secondValType, typename retType>
const RevLanguage::TypeSpec& RevLanguage::Func_sub<firstValType, secondValType, retType>::getReturnType( void ) const {
...
template <typename firstValType, typename secondValType, typename retType>
const RevLanguage::TypeSpec& RevLanguage::Func_sub<firstValType, secondValType, retType>::getTypeSpec( void ) const {
