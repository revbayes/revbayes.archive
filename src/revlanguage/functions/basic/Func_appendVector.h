 ...
 */
template <typename valType>
std::string RevLanguage::Func_appendVector<valType>::getHelpDescription(void) const
{
 ...
 */
template <typename valType>
std::string RevLanguage::Func_appendVector<valType>::getHelpDetails(void) const
{
    // create a variable for the description of the function
