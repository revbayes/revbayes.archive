 ...
 */
template <typename valType>
std::string RevLanguage::Func_modelVector<valType>::getHelpDescription(void) const
{
    // create a variable for the description of the function
    std::string description = "'v' creates a vector of the elements '...'";
 ...
 */
template <typename valType>
std::string RevLanguage::Func_modelVector<valType>::getHelpDetails(void) const
{
    // create a variable for the description of the function
    std::string details =  "'v' creates a vector of the elements '...', which are objects of a common base type. Vector elements may themselves be vectors." ;
