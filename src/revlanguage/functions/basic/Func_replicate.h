 ...
 */
template <typename valType>
std::vector<std::string> RevLanguage::Func_replicate<valType>::getHelpDescription(void) const
{
 ...
 */
template <typename valType>
std::vector<std::string> RevLanguage::Func_replicate<valType>::getHelpDetails(void) const
{
    // create a variable for the description of the function
