 ...
 * of the templated Func_add, which is used to add two
 * variables.
 *
...
class Func_add :  public Function {
    
public:
    Func_add( void );
    
    // Basic utility functions
    Func_add*                                       clone(void) const;                                                              //!< Clone the object
...
/** default constructor */
template <typename firstValType, typename secondValType, typename retType>
RevLanguage::Func_add<firstValType, secondValType, retType>::Func_add( void ) : Function( ) {
...
/** Clone object */
template <typename firstValType, typename secondValType, typename retType>
RevLanguage::Func_add<firstValType, secondValType, retType>* RevLanguage::Func_add<firstValType, secondValType, retType>::clone( void ) const {
    
    return new Func_add( *this );
}


template <typename firstValType, typename secondValType, typename retType>
RevLanguage::RbLanguageObject* RevLanguage::Func_add<firstValType, secondValType, retType>::execute() {
...
/* Get argument rules */
template <typename firstValType, typename secondValType, typename retType>
const RevLanguage::ArgumentRules& RevLanguage::Func_add<firstValType, secondValType, retType>::getArgumentRules( void ) const {
...
template <typename firstValType, typename secondValType, typename retType>
const RevLanguage::TypeSpec& RevLanguage::Func_add<firstValType, secondValType, retType>::getClassTypeSpec(void) { 
...
/* Get return type */
template <typename firstValType, typename secondValType, typename retType>
const RevLanguage::TypeSpec& RevLanguage::Func_add<firstValType, secondValType, retType>::getReturnType( void ) const {
...
template <typename firstValType, typename secondValType, typename retType>
const RevLanguage::TypeSpec& RevLanguage::Func_add<firstValType, secondValType, retType>::getTypeSpec( void ) const {
