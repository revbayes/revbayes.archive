#ifndef Func_sumMatrixReal_H
#define Func_sumMatrixReal_H
...
namespace RevLanguage {
     ...
     *
     */
    class Func_sumMatrixReal :  public TypedFunction<MatrixReal> {
        
    public:
        Func_sumMatrixReal( void );
        
        // Basic utility functions
        Func_sumMatrixReal*                                          clone(void) const;                                          //!< Clone the object
