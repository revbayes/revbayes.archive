#ifndef Func_sumMatrixRealSymmetric_H
#define Func_sumMatrixRealSymmetric_H
...
namespace RevLanguage {
     ...
     *
     */
    class Func_sumMatrixRealSymmetric :  public TypedFunction<MatrixRealSymmetric> {
        
    public:
        Func_sumMatrixRealSymmetric( void );
        
        // Basic utility functions
        Func_sumMatrixRealSymmetric*                                          clone(void) const;                                          //!< Clone the object
