#ifndef RlAdaptivePowerPosteriorAnalysis_H
#define RlAdaptivePowerPosteriorAnalysis_H
...
namespace RevLanguage {
     ...
     *
     *
     * The wraper class provides the Rev interface to the core class AdaptivePowerPosteriorAnalysis.
     * See AdaptivePowerPosteriorAnalysis.h for more details.
     *
     *
     ...
     *
     */
    class AdaptivePowerPosteriorAnalysis : public WorkspaceToCoreWrapperObject<RevBayesCore::AdaptivePowerPosteriorAnalysis> {

    public:

        AdaptivePowerPosteriorAnalysis(void);                                                                                                               //!< Default constructor

        // Basic utility functions
        virtual AdaptivePowerPosteriorAnalysis*     clone(void) const;                                                                      //!< Clone object
