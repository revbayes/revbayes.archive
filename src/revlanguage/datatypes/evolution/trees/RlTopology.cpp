...
RevLanguage::RevPtr<RevVariable> Topology::executeMethod(std::string const &name, const std::vector<Argument> &args, bool &found)
{
    ...
    else if (name == "names")
    {
        ...
        return new RevVariable( new ModelVector<RlString>( tmp ) );
    } 
