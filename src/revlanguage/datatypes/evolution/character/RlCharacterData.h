...
template <class rlCharType>
RevLanguage::CharacterData<rlCharType>::CharacterData( RevBayesCore::TypedDagNode<RevBayesCore::CharacterData<typename rlCharType::valueType> > *d) : AbstractCharacterData() {
    throw RbException("Missing implementation in constructor of CharacterData");
