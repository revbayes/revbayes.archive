...
namespace RevLanguage {
    ...
    public:
        ...
        virtual RbLanguageObject*       divide(const RbLanguageObject &rhs) const;                              //!< Addition operator used for example in '/=' statements
        Real*                           divide(const Integer &rhs) const;                                       //!< Addition operator used for example in '/=' statements
        Real*                           divide(const Real &rhs) const;                                          //!< Addition operator used for example in '/=' statements
        virtual RbLanguageObject*       multiply(const RbLanguageObject &rhs) const;                            //!< Addition operator used for example in '*=' statements
        Integer*                        multiply(const Integer &rhs) const;                                     //!< Addition operator used for example in '*=' statements
        Real*                           multiply(const Real &rhs) const;                                        //!< Addition operator used for example in '*=' statements
        virtual RbLanguageObject*       subtract(const RbLanguageObject &rhs) const;                            //!< Addition operator used for example in '-=' statements
        Integer*                        subtract(const Integer &rhs) const;                                     //!< Addition operator used for example in '-=' statements
        Real*                           subtract(const Real &rhs) const;                                        //!< Addition operator used for example in '-=' statements
