...
#ifndef RlSlidingMove_H
#define RlSlidingMove_H
...
namespace RevLanguage {
    ...
    class SlidingMove : public Move {
        
    public:
        
        SlidingMove(void);                                                                                      //!< Default constructor (0.0)
        
        // Basic utility functions
        virtual SlidingMove*                        clone(void) const;                                                      //!< Clone object
