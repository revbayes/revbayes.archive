...
const MemberRules& Move_SPRNonclock::getMemberRules(void) const {
...
void Move_SPRNonclock::setConstMemberVariable(const std::string& name, const RevPtr<const Variable> &var) {
