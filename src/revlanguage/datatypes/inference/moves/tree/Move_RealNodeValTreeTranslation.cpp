...
const MemberRules& Move_RealNodeValTreeTranslation::getMemberRules(void) const {
    ...
    if ( !rulesSet )
    {
        ...
        memberRules.push_back( new ArgumentRule( "process", RealNodeValTree::getClassTypeSpec(), ArgumentRule::BY_CONSTANT_REFERENCE, ArgumentRule::STOCHASTIC ) );
...
void Move_RealNodeValTreeTranslation::setConstMemberVariable(const std::string& name, const RevPtr<const Variable> &var) {
