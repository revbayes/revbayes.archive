...
namespace RevLanguage {
    ...
    protected:
        ...
        /*
         * Help fields are displayed in the following order:
         *
         * Title
         * Aliases
         * Description
        ...
        virtual std::string                                     getConstructorDetails(void) const { return ""; }
        ...
        virtual std::string                                     getHelpDescription(void) const { return ""; }                                           //!< Get a brief description
        virtual std::string                                     getHelpDetails(void) const { return ""; }                                               //!< Get a more detailed description
        virtual std::string                                     getHelpExample(void) const { return ""; }                                               //!< Get an executable and instructive example
        virtual std::vector<RevBayesCore::RbHelpReference>      getHelpReferences(void) const { return std::vector<RevBayesCore::RbHelpReference>(); }  //!< Get a list of references
        virtual std::vector<std::string>                        getHelpSeeAlso(void) const { return std::vector<std::string>(); }                       //!< Get a list of related help entries
        virtual std::string                                     getHelpTitle(void) const { return ""; }                                                 //!< Get the title of the help entry
