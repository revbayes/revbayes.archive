...
//        
//        // Container functions
//        RevObject*                                      getElement(size_t index) const;                                 //!< Get element (non-const to return non-const element)
//        std::vector<elementType*>*                                      getInternalValue(size_t index);                                 //!< Get element (non-const to return non-const element)
