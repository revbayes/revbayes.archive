...
#ifndef RealPosVector_H
#define RealPosVector_H
...
namespace RevLanguage {
    ...
    class RealPosVector : public TypedContainer<std::vector<double> > {
    ...
    public:
        ...
        RealPosVector(void);                                                                                                  //!< Set type spec of container from type of elements
        RealPosVector(const std::vector<double>& v);                                                                          //!< Set type spec of container from type of elements
        RealPosVector(RevBayesCore::TypedDagNode<std::vector<double> > *c);                                                   //!< Set type spec of container from type of elements
        RealPosVector(const RealPosVector &s);                                                                                      //!< Set type spec of container from type of elements

        virtual                                    ~RealPosVector(void);                                                      //!< Destructor        

        RealPosVector&                                    operator=(const RealPosVector& x);                                    //!< Assignment operator

        // Basic utility functions you have to override
        virtual RealPosVector*                            clone(void) const;                                                  //!< Clone object
