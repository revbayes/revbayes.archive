...
StationarityTest::StationarityTest(double p) : ConvergenceDiagnosticContinuous() {
    
    nBlocks = 10;
    this->p = p;
}

StationarityTest::StationarityTest(int nBlocks, double p) : ConvergenceDiagnosticContinuous() {
