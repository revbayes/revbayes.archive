...
namespace RevBayesCore {
    ...
    public:
        AdmixtureEdgeReplaceFNPR( StochasticNode<AdmixtureTree> *n, DeterministicNode< RbVector<double> >* res, double delta, int ag, int me, bool asa, double weight);                                            //!<  constructor
