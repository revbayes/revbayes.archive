...
class Distribution: public MemberObject {
    ...
    public:
        ...
        virtual const std::string&      getVariableType() const = 0;                //!< Get random variable type
    ...
    protected:
                                        ...
                                        Distribution(const MemberRules& memberRules,
                                                     const MethodTable& methodInits);   //!< Inheritance constructor
