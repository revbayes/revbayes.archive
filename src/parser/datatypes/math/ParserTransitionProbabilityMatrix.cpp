...
public:
    ...
    ParserTransitionProbabilityMatrix(const ParserTransitionProbabilityMatrix& m);                                              //!< Copy constructor
    ~ParserTransitionProbabilityMatrix(void);                                                                                   //!< Destructor
    
    // overloaded operators
    ParserTransitionProbabilityMatrix&  operator=(const ParserTransitionProbabilityMatrix& m);
