...
template <>
RbObject* Func__ne<Integer,Integer>::executeOperation(const std::vector<DAGNode*>& args) {
...
template <>
RbObject* Func__ne<Real,Real>::executeOperation(const std::vector<DAGNode*>& args) {
...
template <>
RbObject* Func__ne<Integer,Real>::executeOperation(const std::vector<DAGNode*>& args) {
...
template <>
RbObject* Func__ne<Real,Integer>::executeOperation(const std::vector<DAGNode*>& args) {
...
const VectorString& Func__ne<firstValType, secondValType>::getClass(void) const {
    ...
    std::string funcAddName = "Func__ne<" + dummy1->getType() + "_" + dummy2->getType() + ">_name"; 
