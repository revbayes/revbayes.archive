...
template <>
DAGNode* Func__ne<Integer,Integer>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__ne<Real,Real>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__ne<Integer,Real>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__ne<Real,Integer>::executeOperation(const std::vector<VariableSlot>& args) {
