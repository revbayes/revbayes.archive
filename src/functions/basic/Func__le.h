...
template <>
DAGNode* Func__le<Integer,Integer>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__le<Real,Real>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__le<Integer,Real>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__le<Real,Integer>::executeOperation(const std::vector<VariableSlot>& args) {
...
const VectorString& Func__le<firstValType, secondValType>::getClass(void) const {
    ...
    std::string funcAddName = "Func__le<" + dummy1->getType() + "," + dummy2->getType() + ">"; 
