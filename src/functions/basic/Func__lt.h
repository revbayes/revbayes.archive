...
template <>
DAGNode* Func__lt<Integer,Integer>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__lt<Real,Real>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__lt<Integer,Real>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__lt<Real,Integer>::executeOperation(const std::vector<VariableSlot>& args) {
