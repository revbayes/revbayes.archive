...
template <>
RbObject* Func__lt<Integer,Integer>::executeOperation(const std::vector<DAGNode*>& args) {
...
template <>
RbObject* Func__lt<Real,Real>::executeOperation(const std::vector<DAGNode*>& args) {
...
template <>
RbObject* Func__lt<Integer,Real>::executeOperation(const std::vector<DAGNode*>& args) {
...
template <>
RbObject* Func__lt<Real,Integer>::executeOperation(const std::vector<DAGNode*>& args) {
...
const VectorString& Func__lt<firstValType, secondValType>::getClass(void) const {
    ...
    std::string funcAddName = "Func__lt<" + dummy1->getType() + "_" + dummy2->getType() + ">_name"; 
