...
template <>
DAGNode* Func__gt<Integer,Integer>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__gt<Real,Real>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__gt<Integer,Real>::executeOperation(const std::vector<VariableSlot>& args) {
...
template <>
DAGNode* Func__gt<Real,Integer>::executeOperation(const std::vector<VariableSlot>& args) {
