...
/** This is the class for the rbeta() function, which takes a single
 *  scalar real or int.
 *
 *  @package    functions
...
class RbFunction_rbeta :  public RbFunction {
    ...
    public:
        static const StringVector   rbClass;            //!< Static class attribute
	        ...
	        ~RbFunction_rbeta();                             //!< Destructor, delete workspace
        ...
        RbFunction_rbeta&   operator=(const RbFunction_rbeta& o);
