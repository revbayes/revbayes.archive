...
class line_wrapping_stdio_filter : public boost::iostreams::stdio_filter {
public:
...
class line_wrapping_input_filter : public boost::iostreams::input_filter {
public:
...
class line_wrapping_output_filter : public boost::iostreams::output_filter {
public:
