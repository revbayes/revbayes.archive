...
//    RevBayesCore::TypedDagNode<RevBayesCore::RbVector< RevBayesCore::RbVector<double> > > *proc = static_cast<const ModelVector<ModelVector<Real> > &>( process->getRevObject() ).getDagNode();
...
//    RevBayesCore::StochasticNode<RevBayesCore::RbVector< RevBayesCore::RbVector<double> > > *p = static_cast<RevBayesCore::StochasticNode<RevBayesCore::RbVector< RevBayesCore::RbVector<double> > > *>( proc );
...
//        memberRules.push_back( new ArgumentRule( "process", ModelVector<ModelVector<Real> >::getClassTypeSpec(), ArgumentRule::BY_REFERENCE, ArgumentRule::STOCHASTIC ) );
