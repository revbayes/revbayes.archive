...
#ifndef TestBranchHeterogeneousGtrModel_H
#define TestBranchHeterogeneousGtrModel_H
...
namespace RevBayesCore {
    ...
    class TestBranchHeterogeneousGtrModel {
        
    public:
        TestBranchHeterogeneousGtrModel(const std::string &alignFile, const std::string &treeFn, int gen);
        virtual                                ~TestBranchHeterogeneousGtrModel(void);                                                            //!< Virtual destructor
