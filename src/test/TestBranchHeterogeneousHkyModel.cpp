...
TestBranchHeterogeneousHkyModel::TestBranchHeterogeneousHkyModel(const std::string &afn, int gen) : alignmentFilename( afn ), mcmcGenerations( gen ){
    
}

TestBranchHeterogeneousHkyModel::~TestBranchHeterogeneousHkyModel() {
    // nothing to do
}
