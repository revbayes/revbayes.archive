...
class ContainerNode : public VariableNode {

    public:
        friend class            Frame;                                                                  //!< Give Frame direct access

                                ContainerNode(Container* x);                                             //!< Vector with const vals from container
                                ContainerNode(DAGNode* x);                                               //!< Vector with one node x
                                ContainerNode(size_t n, DAGNode* x);                                     //!< Vector with n copies of x
                                ContainerNode(size_t n, const std::string& valType);                     //!< Empty vector of length n
                                ContainerNode(const VectorInteger& len, DAGNode* x);                     //!< Array of given dim with copies of x
                                ContainerNode(const VectorInteger& len, const std::string& valType);     //!< Empty array of given dimensions
                                ContainerNode(const ContainerNode& x);                                    //!< Copy constructor
                               ~ContainerNode(void);                                                     //!< Destructor
        ...
        ContainerNode*           clone(void) const;                                                      //!< Clone object
        ...
        ContainerNode*           getSubPlate(const VectorInteger& index) const;                          //!< Get subplate
