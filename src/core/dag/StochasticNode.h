...
public:
    ...
    void                                clamp(RbPtr<RbObject> observedVal);                                 //!< Clamp the node with an observed value
    ...
    void                                setValue(RbPtr<RbObject> value, std::set<RbPtr<StochasticNode> >& affected);     //!< Set value but do not clamp; get affected nodes
