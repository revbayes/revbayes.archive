...
// *
// */
//void NodeOrderConstrainedTreeDistribution::simulateClade(std::vector<TopologyNode *> &n, double age)
//{
//
//    // Get the rng
...
//double NodeOrderConstrainedTreeDistribution::simNextAge(size_t n, double start, double end) const
//{
//
...
// *
// */
//void NodeOrderConstrainedTreeDistribution::simulateTree( void )
//{
//
