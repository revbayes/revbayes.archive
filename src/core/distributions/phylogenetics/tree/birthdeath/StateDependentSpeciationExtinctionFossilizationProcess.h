#ifndef StateDependentSpeciationExtinctionFossilizationProcess_H
#define StateDependentSpeciationExtinctionFossilizationProcess_H
...
namespace RevBayesCore {
     ...
     *
     */
    class StateDependentSpeciationExtinctionFossilizationProcess : public TypedDistribution<Tree> {
        
    public:
        StateDependentSpeciationExtinctionFossilizationProcess(const TypedDagNode<double> *root,
        ...
        virtual StateDependentSpeciationExtinctionFossilizationProcess*              clone(void) const;                                                                                  //!< Create an independent clone
