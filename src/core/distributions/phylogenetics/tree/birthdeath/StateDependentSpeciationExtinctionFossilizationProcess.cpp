...
#include "SSE_ODE.h"
#include "Clade.h"
#include "StateDependentSpeciationExtinctionFossilizationProcess.h"
 ...
 */
StateDependentSpeciationExtinctionFossilizationProcess::StateDependentSpeciationExtinctionFossilizationProcess(const TypedDagNode<double> *ra,
 ...
 */
StateDependentSpeciationExtinctionFossilizationProcess* StateDependentSpeciationExtinctionFossilizationProcess::clone( void ) const
{
    return new StateDependentSpeciationExtinctionFossilizationProcess( *this );
}
 ...
 *
 */
double StateDependentSpeciationExtinctionFossilizationProcess::computeLnProbability( void )
{
...
void StateDependentSpeciationExtinctionFossilizationProcess::computeNodeProbability(const RevBayesCore::TopologyNode &node, size_t node_index) const
{
...
double StateDependentSpeciationExtinctionFossilizationProcess::computeRootLikelihood( void ) const
{
...
const AbstractHomologousDiscreteCharacterData& StateDependentSpeciationExtinctionFossilizationProcess::getCharacterData() const
{
    return static_cast<TreeDiscreteCharacterData*>(this->value)->getCharacterData();
}


void StateDependentSpeciationExtinctionFossilizationProcess::drawJointConditionalAncestralStates(std::vector<size_t>& startStates, std::vector<size_t>& endStates)
{
...
void StateDependentSpeciationExtinctionFossilizationProcess::recursivelyDrawJointConditionalAncestralStates(const TopologyNode &node, std::vector<size_t>& startStates, std::vector<size_t>& endStates)
{
...
void StateDependentSpeciationExtinctionFossilizationProcess::drawStochasticCharacterMap(std::vector<std::string*>& character_histories)
{
...
void StateDependentSpeciationExtinctionFossilizationProcess::recursivelyDrawStochasticCharacterMap(const TopologyNode &node, size_t start_state, std::vector<std::string*>& character_histories)
{
...
void StateDependentSpeciationExtinctionFossilizationProcess::executeProcedure(const std::string &name, const std::vector<DagNode *> args, bool &found)
{
 ...
 */
void StateDependentSpeciationExtinctionFossilizationProcess::getAffected(RbOrderedSet<DagNode *> &affected, RevBayesCore::DagNode *affecter)
{
 ...
 */
void StateDependentSpeciationExtinctionFossilizationProcess::keepSpecialization(DagNode *affecter)
{
...
double StateDependentSpeciationExtinctionFossilizationProcess::pSurvival(double start, double end) const
{
 ...
 */
void StateDependentSpeciationExtinctionFossilizationProcess::redrawValue( void )
{
 ...
 */
void StateDependentSpeciationExtinctionFossilizationProcess::restoreSpecialization(DagNode *affecter)
{
...
void StateDependentSpeciationExtinctionFossilizationProcess::setCladogenesisMatrix(const TypedDagNode< MatrixReal >* cm)
{
...
void StateDependentSpeciationExtinctionFossilizationProcess::setFossilizationRates(const TypedDagNode< RbVector<double> >* r)
{
...
void StateDependentSpeciationExtinctionFossilizationProcess::setSampleCharacterHistory(bool sample_history)
{
    sample_character_history = sample_history;
}


void StateDependentSpeciationExtinctionFossilizationProcess::setSpeciationRates(const TypedDagNode< RbVector<double> >* r)
{
...
void StateDependentSpeciationExtinctionFossilizationProcess::setNumberOfTimeSlices( double n )
{
 ...
 */
void StateDependentSpeciationExtinctionFossilizationProcess::setValue(Tree *v, bool f )
{
 ...
 *
 */
void StateDependentSpeciationExtinctionFossilizationProcess::simulateTree( void )
{
 ...
 */
void StateDependentSpeciationExtinctionFossilizationProcess::swapParameterInternal(const DagNode *oldP, const DagNode *newP)
{
 ...
 * If the root age variable has been restored, then we need to change the root age of the tree too.
 */
void StateDependentSpeciationExtinctionFossilizationProcess::touchSpecialization(DagNode *affecter, bool touchAll)
{
 ...
 */
void StateDependentSpeciationExtinctionFossilizationProcess::numericallyIntegrateProcess(state_type &likelihoods, double begin_age, double end_age, bool backward_time, bool extinction_only) const
{
