...
template<class charType, class treeType>
RevBayesCore::FilteredPhyloCTMCSiteHomogeneous<charType, treeType>::FilteredPhyloCTMCSiteHomogeneous(const RevBayesCore::TypedDagNode<treeType> *t, size_t nChars, bool compressed, size_t nSites) : AbstractPhyloCTMCSiteHomogeneous<charType>(  t, nChars, 1, compressed, nSites ) {
