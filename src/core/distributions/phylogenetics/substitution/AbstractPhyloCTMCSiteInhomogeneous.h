#ifndef AbstractPhyloCTMCSiteInhomogeneous_H
#define AbstractPhyloCTMCSiteInhomogeneous_H
...
namespace RevBayesCore {
    ...
    /**
     * @brief Inhomogeneous distribution of character state evolution along a tree class (PhyloCTMC).
     *
     * This file contains the distribution class for a character state evolving along a tree.
     * This abstract base class can be derived for any character evolution model with inhomogeneous mixture sites. An
     * inhomogeneous mixture model over sites is a model where sites are drawn from their own distributions and the
     * specific instance of the per site parameter is integrated over. The per site parameter can be a rate scaler (e.g. the + gamma models)
    ...
    class AbstractPhyloCTMCSiteInhomogeneous : public TypedDistribution< AbstractHomologousDiscreteCharacterData >, public MemberObject< RbVector<double> >, public MemberObject < MatrixReal >, public TreeChangeEventListener {

    public:
        // Note, we need the size of the alignment in the constructor to correctly simulate an initial state
        AbstractPhyloCTMCSiteInhomogeneous(const TypedDagNode<Tree> *t, size_t nChars, size_t nMix, bool c, size_t nSites, bool amb, bool wd = false, bool internal = false, bool gapmatch = true );
        AbstractPhyloCTMCSiteInhomogeneous(const AbstractPhyloCTMCSiteInhomogeneous &n);                                                                                    //!< Copy constructor
        virtual                                                            ~AbstractPhyloCTMCSiteInhomogeneous(void);                                                     //!< Virtual destructor

        // public member functions
        // pure virtual
        virtual AbstractPhyloCTMCSiteInhomogeneous*                           clone(void) const = 0;                                                                      //!< Create an independent clone
...
template<class charType>
RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::AbstractPhyloCTMCSiteInhomogeneous(const TypedDagNode<Tree> *t, size_t nChars, size_t nMix, bool c, size_t nSites, bool amb, bool internal, bool gapmatch, bool wd) :
...
template<class charType>
RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::AbstractPhyloCTMCSiteInhomogeneous(const AbstractPhyloCTMCSiteInhomogeneous &n) :
 ...
 */
template<class charType>
RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::~AbstractPhyloCTMCSiteInhomogeneous( void )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::bootstrap( void )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::compress( void )
{
...
template<class charType>
double RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::computeLnProbability( void )
{
    // @todo: #thread
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::computeMarginalNodeLikelihood( size_t node_index, size_t parentnode_index )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::computeMarginalRootLikelihood( void )
{
    // get the root node
    const TopologyNode &root = tau->getValue().getRoot();
 ...
 */
template<class charType>
std::vector<charType> RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::drawAncestralStatesForNode(const TopologyNode &node)
{
 ...
 */
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::drawJointConditionalAncestralStates(std::vector<std::vector<charType> >& startStates, std::vector<std::vector<charType> >& endStates)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::drawStochasticCharacterMap(std::vector<std::string*>& character_histories, size_t site, bool use_simmap_default)
{
...
template<class charType>
bool RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::recursivelyDrawStochasticCharacterMap(const TopologyNode &node, std::vector<std::string*>& character_histories, std::vector<std::vector<charType> >& start_states, std::vector<std::vector<charType> >& end_states, size_t site, bool use_simmap_default)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::executeMethod(const std::string &n, const std::vector<const DagNode *> &args, RbVector<double> &rv) const
{
    ...
    if ( n == "siteLikelihoods" )
    {
        ...
        const_cast<AbstractPhyloCTMCSiteInhomogeneous<charType> *>( this )->computeLnProbability();
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::executeMethod(const std::string &n, const std::vector<const DagNode *> &args, MatrixReal &rv) const
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::recursivelyDrawJointConditionalAncestralStates(const TopologyNode &node, std::vector<std::vector<charType> >& startStates, std::vector<std::vector<charType> >& endStates, const std::vector<size_t>& sampledSiteRates)
{
    RandomNumberGenerator* rng = GLOBAL_RNG;
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::tipDrawJointConditionalAncestralStates(const TopologyNode &node, std::vector<std::vector<charType> >& startStates, std::vector<std::vector<charType> >& endStates, const std::vector<size_t>& sampledSiteRates)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::fillLikelihoodVector(const TopologyNode &node, size_t node_index)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::fireTreeChangeEvent( const RevBayesCore::TopologyNode &n, const unsigned& m )
{
...
template<class charType>
std::vector<size_t> RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::getIncludedSiteIndices( void )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::getRootFrequencies( std::vector<std::vector<double> >& rf ) const
{
...
template<class charType>
std::vector<double> RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::getRootFrequencies( size_t mixture ) const
{
...
template<class charType>
std::vector<double> RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::getMixtureProbs( void ) const
{
...
template<class charType>
double RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::getPInv( void ) const
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::keepSpecialization( DagNode* affecter )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::recursivelyFlagNodeDirty( const RevBayesCore::TopologyNode &n )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::recursiveMarginalLikelihoodComputation( size_t node_index )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::redrawValue( void )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::reInitialized( void )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::resizeLikelihoodVectors( void )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::restoreSpecialization( DagNode* affecter )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::scale( size_t node_index)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::scale( size_t node_index, size_t left, size_t right )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::scale( size_t node_index, size_t left, size_t right, size_t middle )
{
...
template <class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setActivePIDSpecialized(size_t a, size_t n)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setValue(AbstractHomologousDiscreteCharacterData *v, bool force)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::simulate( const TopologyNode &node, std::vector< DiscreteTaxonData< charType > > &taxa, const std::vector<bool> &invariant, const std::vector<size_t> &perSiteMixtures)
{
...
template<class charType>
const RevBayesCore::TypedDagNode<RevBayesCore::Tree>* RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::getTree()
{
    return tau;
}
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setClockRate(const TypedDagNode< double > *r)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setClockRate(const TypedDagNode< RbVector< double > > *r)
{
 ...
 */
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setMcmcMode(bool tf)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setPInv(const TypedDagNode< double > *r)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setRateMatrix(const TypedDagNode< RateGenerator > *rm)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setRateMatrix(const TypedDagNode< RbVector< RateGenerator > > *rm)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setRootFrequencies(const TypedDagNode< Simplex > *f)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setSiteRates(const TypedDagNode< RbVector< double > > *r)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setSiteRatesProbs(const TypedDagNode< Simplex > *rp)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setUseMarginalLikelihoods(bool tf)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::setUseSiteMatrices(bool use_sm, const TypedDagNode< Simplex > *s)
{
...
template<class charType>
std::vector< std::vector<double> >* RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::sumMarginalLikelihoods( size_t node_index )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::computeRootLikelihoods( std::vector<double> &rv ) const
{
    // get the root node
    const TopologyNode &root = tau->getValue().getRoot();
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::computeRootLikelihoodsPerSiteMixture( MatrixReal &rv ) const
{
    // get the root node
    const TopologyNode &root = tau->getValue().getRoot();
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::computeRootLikelihoodsPerSiteRate( MatrixReal &rv ) const
{
    // get the root node
    const TopologyNode &root = tau->getValue().getRoot();
...
template<class charType>
double RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::sumRootLikelihood( void )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::swap_taxon_name_2_tip_index(std::string tip1, std::string tip2)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::swapParameterInternal(const DagNode *oldP, const DagNode *newP)
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::touchSpecialization( DagNode* affecter, bool touch_all )
{
...
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::updateMarginalNodeLikelihoods( void )
{
 ...
 */
template<class charType>
void RevBayesCore::AbstractPhyloCTMCSiteInhomogeneous<charType>::updateTransitionProbabilities(size_t node_idx)
{
