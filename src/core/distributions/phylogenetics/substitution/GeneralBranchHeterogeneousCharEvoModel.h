...
//template<class charType, class treeType>
//void RevBayesCore::GeneralBranchHeterogeneousCharEvoModel<charType, treeType>::computeRootLikelihood( size_t root, size_t left, size_t right, size_t middle)
//{
//    
//    // reset the likelihood
//    this->lnProb = 0.0;
...
template<class charType, class treeType>
void RevBayesCore::GeneralBranchHeterogeneousCharEvoModel<charType, treeType>::computeInternalNodeLikelihood(const TopologyNode &node, size_t nodeIndex, size_t left, size_t right, size_t middle)
{
    ...
    // get the pointers to the partial likelihoods for this node and the two descendant subtrees
    const double*   p_left      = this->partialLikelihoods + this->activeLikelihood[left]*this->activeLikelihoodOffset + left*this->nodeOffset;
    const double*   p_middle    = this->partialLikelihoods + this->activeLikelihood[middle]*this->activeLikelihoodOffset + left*this->nodeOffset;
    const double*   p_right     = this->partialLikelihoods + this->activeLikelihood[right]*this->activeLikelihoodOffset + right*this->nodeOffset;
    double*         p_node      = this->partialLikelihoods + this->activeLikelihood[nodeIndex]*this->activeLikelihoodOffset + nodeIndex*this->nodeOffset;
...
template<class charType, class treeType>
double RevBayesCore::GeneralBranchHeterogeneousCharEvoModel<charType, treeType>::sumPartialLikelihoods( size_t nodeIndex )
{
