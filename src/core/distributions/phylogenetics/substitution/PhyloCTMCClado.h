...
//        marginalLikelihoods = new double[num_nodes*numSiteRates*pattern_block_size*numChars];
        memcpy(cladoMarginalLikelihoods, n.cladoMarginalLikelihoods, this->num_nodes*this->numSiteRates*this->num_sites*this->numChars*this->numChars*sizeof(double));
    }
...
//            std::cout << nodeIdx << " " << events.size() << "\n";
            ...
            for (it = events.begin(); it != events.end(); it++)
            {
                ...
                rm->calculateTransitionProbabilities(event_age+dt, event_age, rate, this->transitionProbMatrices[0] );
...
//                std::cout << tp << "\n\n";
            ...
            rm->calculateTransitionProbabilities( event_age, endAge,  rate, this->transitionProbMatrices[0] );
            tp *= this->transitionProbMatrices[0];
