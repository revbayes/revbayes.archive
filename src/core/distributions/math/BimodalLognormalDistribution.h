...
namespace RevBayesCore {
    ...
    /**
     * This class implements the bimodal lognormal distribution.
     *
     * The bimodal lognormal distribution is a mixture of two lognormal distributions.
     * Each lognormal distribution has its own parameterization: mu1 and stDev1 and respectively mu2 and stDev2.
