...
double Dist_beta::lnPdf( RbPtr<const RbLanguageObject> value ) const {
    ...
    double shape1 = static_cast<const RealPos*>((const RbLanguageObject*)getMemberValue("shape1"))->getValue();
    double shape2 = static_cast<const RealPos*>((const RbLanguageObject*)getMemberValue("shape2"))->getValue();
    double x      = static_cast<const RealPos*>((const RbLanguageObject*)value)->getValue();
