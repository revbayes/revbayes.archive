...
const std::string CharacterMatrixDiscrete_name                  = "Discrete character matrix";
const std::string CharacterMatrixContinuous_name                = "Continuous character matrix";
const std::string CharacterState_name                           = "CharacterState";
