...
RlValue<RbLanguageObject> MemberFunction::execute( void ) {
...
void MemberFunction::setArgumentVariable(std::string const &name, const RbPtr<const RbLanguageObject> &var) {
