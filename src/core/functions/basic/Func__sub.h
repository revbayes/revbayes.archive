...
class Func__sub :  public RbFunction {
    ...
    public:
                                    Func__sub( void );
                                    Func__sub( const Func__sub& f);
        virtual                    ~Func__sub( void );
    
        // overloaded operators
        Func__sub&                  operator=( const Func__sub& f);
...
/** default constructor */
template <typename firstValType, typename secondValType, typename retType>
Func__sub<firstValType, secondValType, retType>::Func__sub( void ) : RbFunction( ) {
    first  = NULL;
    second = NULL;
}
...
/** default constructor */
template <typename firstValType, typename secondValType, typename retType>
Func__sub<firstValType, secondValType, retType>::Func__sub( const Func__sub& f ) : RbFunction( f ) {
...
/** destructor */
template <typename firstValType, typename secondValType, typename retType>
Func__sub<firstValType, secondValType, retType>::~Func__sub( void ) {
...
template <typename firstValType, typename secondValType, typename retType>
Func__sub<firstValType,secondValType,retType>& Func__sub<firstValType, secondValType, retType>::operator=( Func__sub<firstValType, secondValType, retType> const &f ) {
...
template <typename firstValType, typename secondValType, typename retType>
const TypeSpec& Func__sub<firstValType, secondValType, retType>::getClassTypeSpec(void) { 
...
template <typename firstValType, typename secondValType, typename retType>
void Func__sub<firstValType, secondValType, retType>::setArgumentVariable(std::string const &name, const Variable* var) {
