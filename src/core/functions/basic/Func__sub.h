...
template <typename firstValType, typename secondValType, typename retType>
RbPtr<RbObject> Func__sub<firstValType,secondValType,retType>::execute( void ) {
    ...
    return RbPtr<RbObject>( diff.clone() );
}


/** Get argument rules */
template <typename firstValType, typename secondValType, typename retType>
RbPtr<const ArgumentRules> Func__sub<firstValType, secondValType, retType>::getArgumentRules( void ) const {
