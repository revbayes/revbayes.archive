...
template <typename firstValType, typename secondValType>
RbPtr<RbLanguageObject> Func__ne<firstValType,secondValType>::executeFunction( void ) {
...
/** Get argument rules */
template <typename firstValType, typename secondValType>
RbPtr<const ArgumentRules> Func__ne<firstValType, secondValType>::getArgumentRules(void) const {
