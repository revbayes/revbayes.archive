...
ArgumentRule::ArgumentRule(const std::string& argName, RbPtr<RbObject> defVal) : RbInternal(), label(argName), argSlot(argName, defVal->getTypeSpec()), hasDefaultVal(true) {
...
ArgumentRule::ArgumentRule(const std::string& argName, const TypeSpec& argTypeSp, RbPtr<RbObject> defValue) : RbInternal(), label(argName), argSlot(argName,argTypeSp), hasDefaultVal(true) {
