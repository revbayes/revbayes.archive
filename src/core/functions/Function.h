...
namespace RevBayesCore {
  ...
  protected:
    ...
    virtual void                        addParameter(const DagNode* p);                                         //!< add a parameter to the function
    virtual void                        removeParameter(const DagNode* p);                                      //!< remove a parameter from the function
