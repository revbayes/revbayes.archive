#ifndef TaxonDateReader_H
#define TaxonDateReader_H
...
namespace RevBayesCore {
     ...
     *
     */
    class TaxonDateReader : public DelimitedDataReader {
        
    public:
        
        TaxonDateReader(const std::string &fn, char d='\t');                    //!< Constructor
