...
namespace RevBayesCore {
    ...
    public:
        ...
        ContinuousCharacterData&                        concatenate(const ContinuousCharacterData &d, std::string type = "strict");                              //!< Concatenate data matrices
        ContinuousCharacterData&                        concatenate(const HomologousCharacterData &d, std::string type = "strict");                              //!< Concatenate data matrices
        ContinuousCharacterData&                        concatenate(const AbstractCharacterData &d, std::string type = "strict");                                //!< Concatenate data matrices
