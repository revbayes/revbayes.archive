...
class RbObject {
    ...
    public:
        ...
        virtual bool                        allowsVariableInsertion(void) const { return false; }                   //!< Do we allow variable to be RbDagNodePtred in this object (only appicable for some container, e.g. DagNodeContainer)
