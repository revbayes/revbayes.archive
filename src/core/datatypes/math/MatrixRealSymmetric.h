...
////
//
//#ifndef __revbayes__MatrixReal__
//#define __revbayes__MatrixReal__
//
//#include <iostream>
//
...
//    class EigenSystem;
//    
//    class MatrixReal : public MatrixReal, public MemberObject<double> {
//        
//    public:
////                                            MatrixReal(void);                                              //!< Default constructor required by revlanguae use
//                                            MatrixReal(size_t n);                                          //!< Construct rate matrix with n states
////                                            MatrixReal(const MatrixReal& m);                          //!< Copy constructor
//                                            MatrixReal(const MatrixReal& m);                          //!< Copy constructor
//        
//        virtual                            ~MatrixReal(void) {}                                            //!< Destructor
//                
//        // public methods
