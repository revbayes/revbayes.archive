#ifndef RbRbBitSetByte_H
#define RbRbBitSetByte_H
...
namespace RevBayesCore {
     ...
     */
    class RbBitSetByte : public RbBitSet {
        
    public:
        RbBitSetByte(void);                                                                                         //!< Constructor requires character type
        RbBitSetByte(size_t n, bool set=false);                                                                     //!< Constructor requires character type
        virtual                        ~RbBitSetByte(void);
    ...
    std::ostream&                               operator<<(std::ostream& o, const RbBitSetByte& x);                    //!< Overloaded output operator
