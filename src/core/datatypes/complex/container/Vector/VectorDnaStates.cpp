...
VectorDnaStates::VectorDnaStates(void) : VectorCharacterObservations(VectorDnaStates_name) {
    
}


/** Copy constructor */
VectorDnaStates::VectorDnaStates(const VectorDnaStates& x) : VectorCharacterObservations(VectorDnaStates_name) {
