...
//        virtual DAGNode*                            getMemberDagNode(const std::string& name);                                          //!< Get member variable (non-const node)
        virtual const DAGNode*                      getMember(const std::string& name) const;                                           //!< Get member variable 
        virtual DAGNode*                            getMember(const std::string& name);                                                 //!< Get member variable (non-const node)
        ...
        const std::vector<RbDagNodePtr>&            getMembers(void) const;                                                             //!< Get members
        std::vector<RbDagNodePtr>&                  getMembers(void);                                                                   //!< Get members
        void                                        setMember(const std::string& name, DAGNode* var);                                   //!< Set member variable
...
//        virtual void                                setMemberVariable(const std::string& name, Variable* var);                          //!< Set member variable
    ...
    protected:
        ...
        std::vector<RbDagNodePtr>                   members;                                                                            //!< Member variables
};
