...
class MemberObject: public RbLanguageObject {
    ...
    protected:
        ...
        virtual RbPtr<RbLanguageObject>     executeOperationSimple(const std::string& name, const RbPtr<Environment>& args);    //!< Override to map member methods to internal functions
