...
#ifdef RB_MPI
        void                                                run(size_t k, RbVector<StoppingRule> r, const MPI_Comm &c, size_t ti, double p, bool verbose=true);
#else
        void                                                run(size_t k, RbVector<StoppingRule> r, size_t ti, double p, bool verbose=true);
#endif
