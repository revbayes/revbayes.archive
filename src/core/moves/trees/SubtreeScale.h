...
#ifndef SubtreeScale_H
#define SubtreeScale_H
...
namespace RevBayesCore {
    ...
    class SubtreeScale : public SimpleMove {
    
    public:
        SubtreeScale( StochasticNode<TimeTree> *n, double weight);                                                          //!<  constructor
    
        // Basic utility functions
        SubtreeScale*                   clone(void) const;                                                                  //!< Clone object
