...
#ifndef GibbsPruneAndRegraft_H
#define GibbsPruneAndRegraft_H
...
namespace RevBayesCore {
    ...
    class GibbsPruneAndRegraft : public SimpleMove {
        
    public:
        GibbsPruneAndRegraft( StochasticNode<TimeTree> *n, double weight);                                            //!<  constructor
        
        // Basic utility functions
        GibbsPruneAndRegraft*           clone(void) const;                                                                  //!< Clone object
