#ifndef NodeTimeSliceProposal_H
#define NodeTimeSliceProposal_H
...
namespace RevBayesCore {
     ...
     *
     */
    class NodeTimeSliceProposal : public Proposal {
        
    public:
        NodeTimeSliceProposal( StochasticNode<Tree> *n);                                               //!<  constructor
        
        // Basic utility functions
        void                                    cleanProposal(void);                                        //!< Clean up proposal
        NodeTimeSliceProposal*                  clone(void) const;                                          //!< Clone object
