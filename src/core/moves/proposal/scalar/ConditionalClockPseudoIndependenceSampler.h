#ifndef ConditionalClockISProposal_H
#define ConditionalClockISProposal_H
...
namespace RevBayesCore {
     ...
     *
     */
    class ConditionalClockISProposal : public Proposal {
        
    public:
        ConditionalClockISProposal(StochasticNode<double>* n, StochasticNode<Tree> *t, double s, int x, int N, bool l);                             //!< Constructor
        
        void                                        cleanProposal(void);                                                                //!< Clean up proposal
        ConditionalClockISProposal*                       clone(void) const;                                                                  //!< Clone object
    ...
    private:
        ...
        StochasticNode<Tree>                       *tree;                                                                             //!< The tree.
