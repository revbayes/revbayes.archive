...
//
//        memberRules.push_back(new ConstArgumentRule("tuning", RealPos::getClassTypeSpec()) );
//        memberRules.push_back(new ConstArgumentRule("num_cats", Natural::getClassTypeSpec()) );
//
//        rulesSet = true;
//		}
//
