//
//  AdmixtureEdgeReplaceResidualsFNPR.cpp
//  rb_mlandis
//
...
#include "AdmixtureEdgeReplaceResidualsFNPR.h"
...
/* Clone object */
AdmixtureEdgeReplaceResidualsFNPR* AdmixtureEdgeReplaceResidualsFNPR::clone( void ) const {
    
    return new AdmixtureEdgeReplaceResidualsFNPR( *this );
}



const std::string& AdmixtureEdgeReplaceResidualsFNPR::getMoveName( void ) const {
    static std::string name = "AdmixtureEdgeReplaceResidualsFNPR";
    
    return name;
}

void AdmixtureEdgeReplaceResidualsFNPR::findDescendantTips(std::set<AdmixtureNode*>& s, AdmixtureNode* p)
{
...
void AdmixtureEdgeReplaceResidualsFNPR::rejectSimpleMove( void ) {
...
void AdmixtureEdgeReplaceResidualsFNPR::acceptSimpleMove(void) {
...
void AdmixtureEdgeReplaceResidualsFNPR::swapNode(DagNode *oldN, DagNode *newN) {
...
void AdmixtureEdgeReplaceResidualsFNPR::rejectMove( void ) {
    changed = false;
...
void AdmixtureEdgeReplaceResidualsFNPR::acceptMove( void ) {
    // nothing to do
    changed = false;
