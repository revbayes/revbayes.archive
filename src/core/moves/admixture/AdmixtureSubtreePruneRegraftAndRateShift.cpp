//
//  AdmixtureSubtreePruneRegraftAndRateShiftAndRateShift.cpp
//  rb_mlandis
//
...
/* Clone object */
AdmixtureSubtreePruneRegraftAndRateShift* AdmixtureSubtreePruneRegraftAndRateShift::clone( void ) const {
    
    return new AdmixtureSubtreePruneRegraftAndRateShift( *this );
}



const std::string& AdmixtureSubtreePruneRegraftAndRateShift::getMoveName( void ) const {
...
/** Perform the move */
double AdmixtureSubtreePruneRegraftAndRateShift::performCompoundMove( void ) {
    ...
    tree->getValue().getRoot().flagNewickRecomputation();
    
    // propose rate
    storedRate = rate->getValue();
...
void AdmixtureSubtreePruneRegraftAndRateShift::swapNode(DagNode *oldN, DagNode *newN) {
    ...
    if (oldN == tree)
        ...
        rate = static_cast<ContinuousStochasticNode* >(newN);
}
