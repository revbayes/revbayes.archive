 ...
 * \throws Throws an MbException::ERROR.
 */
double RbStatistics::Multinomial::pdf(const std::vector<double> &p, const RbVector<Natural> &x) {
 ...
 * \throws Does not throw an error.
 */
double RbStatistics::Multinomial::lnPdf(const std::vector<double> &p, const RbVector<Natural> &x) {
