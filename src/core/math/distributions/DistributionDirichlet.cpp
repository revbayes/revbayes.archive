 ...
 * \throws Throws an MbException::ERROR.
 */
double RbStatistics::Dirichlet::pdf(const RbVector<RealPos> &a, const std::vector<double> &z) {
 ...
 * \throws Does not throw an error.
 */
double RbStatistics::Dirichlet::lnPdf(const RbVector<RealPos> &a, const std::vector<double> &z) {
 ...
 * \throws Does not throw an error.
 */
double RbStatistics::Dirichlet::lnPdf(const std::vector<double> &a, const RbVector<RealPos> &z) {
 ...
 * \throws Does not throw an error.
 */
std::vector<double> RbStatistics::Dirichlet::rv(const RbVector<RealPos> &a, RandomNumberGenerator& rng) {
