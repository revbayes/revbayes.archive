...
namespace RbStatistics {
    ...
    namespace Normal {
        ...
        double                      rv(RbPtr<RandomNumberGenerator> rng);                                         /*!< Normal(0,1) random variable */
        double                      rv(double mu, double sigma, RbPtr<RandomNumberGenerator> rng);                /*!< Normal(mu,sigma) random variable */
	}
}