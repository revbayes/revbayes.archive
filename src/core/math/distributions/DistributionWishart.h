...
namespace RevBayesCore {
    ...
    namespace RbStatistics {
        ...
        namespace Wishart {
            ...
            double                      pdf(const MatrixRealSymmetric& omega0, size_t df, const MatrixRealSymmetric& z);        /*!< Dirichlet(a[]) probability density */
            double                      lnPdf(const MatrixRealSymmetric& omega0, size_t df, const MatrixRealSymmetric& z);      /*!< Dirichlet(a[]) log_e probability density */
            MatrixRealSymmetric             rv(const MatrixRealSymmetric& omega0, size_t df, RandomNumberGenerator& rng);           /*!< Dirichlet(a[]) random variable */
